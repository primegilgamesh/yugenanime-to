        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex items-center border border-gray-200 rounded-lg px-3 py-2.5 gap-2">
              ...
              <input placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} className="flex-1 outline-none text-sm text-gray-700 placeholder:text-gray-400" />
            </div>
            <div className="flex items-center border border-gray-200 rounded-lg px-3 py-2.5 gap-2">
            ...
            <div className="flex gap-3">
              <div className="flex-1 flex items-center border border-gray-200 rounded-lg px-3 py-2.5 gap-2">
              ...
              <div className="flex-1 flex items-center border border-gray-200 rounded-lg px-3 py-2.5 gap-2">
                <Lock size={16} className="text-gray-400" />
                <input type="password" placeholder="Repeat" value={repeat} onChange={(e) => setRepeat(e.target.value)} className="flex-1 outline-none text-sm text-gray-700 placeholder:text-gray-400" />
              </div>
            </div>
      ...
      <div className="md:hidden flex flex-col min-h-screen relative z-10">
        ...
        <div className="flex-1 bg-white rounded-t-3xl px-6 pt-8 pb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-3">
              <div className="flex-1 flex items-center border border-gray-200 rounded-lg px-3 py-3 gap-2">
                <Lock size={16} className="text-gray-400" />
                <input type="password" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} className="flex-1 outline-none text-sm text-gray-700 placeholder:text-gray-400" />
              </div>
              <div className="flex-1 flex items-center border border-gray-200 rounded-lg px-3 py-3 gap-2">
