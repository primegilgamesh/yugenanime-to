...
export const recentlyReleased: AnimeEntry[] = [
  ...
  { slug: "jujutsu-kaisen-season-2", title: "Jujutsu Kaisen Season 2", titleRomaji: "Jujutsu Kaisen 2nd Season", titleEnglish: "Jujutsu Kaisen Season 2", titleNative: "呪術廻戦 第2期", season: "Summer 2023", score: 8.6, cover: gradients[8], episodes: 23, views: "416 views", timeAgo: "about 16 hours ago", studios: "MAPPA", format: "TV", genres: "Action, Fantasy, School", status: "Finished Airing", premiered: "Summer 2023", duration: "24 min per ep", favorites: 3200, synopsis: "The past comes to light as Gojo's backstory is revealed, followed by the devastating Shibuya Incident arc." },
];

export const trendingAiring: AnimeEntry[] = [
  { slug: "frieren", title: "Sousou no Frieren", titleRomaji: "Sousou no Frieren", titleEnglish: "Frieren: Beyond Journey's End", titleNative: "葬送のフリーレン", season: "Fall 2023", score: 9.18, cover: gradients[0], studios: "Madhouse", format: "TV", genres: "Adventure, Drama, Fantasy", episodes: 28, status: "Finished Airing", premiered: "Fall 2023", duration: "24 min per ep", favorites: 1217, synopsis: "During their decade-long quest to defeat the Demon King, the members of the hero's party forge bonds through adventures and battles." },
  { slug: "kusuriya-no-hitorigoto", title: "Kusuriya no Hitorigoto", titleRomaji: "Kusuriya no Hitorigoto", titleEnglish: "The Apothecary Diaries", titleNative: "薬屋のひとりごと", season: "Fall 2023", score: 8.83, cover: gradients[1], studios: "TOHO Animation", format: "TV", genres: "Drama, Mystery, Historical", episodes: 24, status: "Finished Airing", premiered: "Fall 2023", duration: "24 min per ep", favorites: 980, synopsis: "A young pharmacist named Maomao is kidnapped and sold to the emperor's palace. Using her pharmaceutical knowledge, she becomes involved in various incidents." },
  ...
  { slug: "one-piece", title: "One Piece", titleRomaji: "One Piece", titleEnglish: "One Piece", titleNative: "ワンピース", season: "Fall 1999", score: 8.72, cover: gradients[4], studios: "Toei Animation", format: "TV", genres: "Action, Adventure, Fantasy", episodes: 1100, status: "Currently Airing", premiered: "Fall 1999", duration: "24 min per ep", favorites: 5432, synopsis: "Monkey D. Luffy sets out on an adventure to find the legendary treasure One Piece and become the Pirate King." },
...
export const editorsPick: AnimeEntry[] = [
  { slug: "angel-beats", title: "Angel Beats!", titleRomaji: "Angel Beats!", titleEnglish: "Angel Beats!", titleNative: "Angel Beats!", season: "Spring 2010", score: 8.09, cover: gradients[6], studios: "P.A.Works", format: "TV", genres: "Action, Comedy, Drama", episodes: 13, status: "Finished Airing", premiered: "Spring 2010", duration: "24 min per ep", favorites: 3100, synopsis: "Otonashi awakens in the afterlife with no memories. He meets Yuri who leads a rebel group fighting against God." },
...
export const mostPopular: AnimeEntry[] = [
  { slug: "bleach-sennen-kessen-hen", title: "Bleach: Sennen Kessen-hen", titleRomaji: "Bleach: Sennen Kessen-hen", titleEnglish: "Bleach: Thousand-Year Blood War", titleNative: "BLEACH 千年血戦篇", season: "Fall 2022", score: 9.23, cover: gradients[0], dubbed: true, studios: "Pierrot", format: "TV", genres: "Action, Adventure, Fantasy", episodes: 13, status: "Finished Airing", premiered: "Fall 2022", duration: "24 min per ep", favorites: 4500, synopsis: "Ichigo Kurosaki and the Soul Reapers face their greatest threat as the Wandenreich declares war on Soul Society." },
  { slug: "fullmetal-alchemist-brotherhood", title: "Fullmetal Alchemist: Brotherhood", titleRomaji: "Hagane no Renkinjutsushi: Fullmetal Alchemist", titleEnglish: "Fullmetal Alchemist: Brotherhood", titleNative: "鋼の錬金術師 FULLMETAL ALCHEMIST", season: "Spring 2009", score: 9.22, cover: gradients[1], dubbed: true, studios: "Bones", format: "TV", genres: "Action, Adventure, Drama, Fantasy", episodes: 64, status: "Finished Airing", premiered: "Spring 2009", duration: "24 min per ep", favorites: 8900, synopsis: "Two brothers search for the Philosopher's Stone to restore their bodies after a failed attempt to bring their mother back to life through alchemy." },
  ...
  { slug: "shingeki-no-kyojin-final", title: "Shingeki no Kyojin: The Final Season", titleRomaji: "Shingeki no Kyojin: The Final Season", titleEnglish: "Attack on Titan: The Final Season", titleNative: "進撃の巨人 The Final Season", season: "Winter 2021", score: 9.15, cover: gradients[4], dubbed: true, studios: "MAPPA", format: "TV", genres: "Action, Drama, Fantasy, Military", episodes: 16, status: "Finished Airing", premiered: "Winter 2021", duration: "24 min per ep", favorites: 7200, synopsis: "The final season follows Eren's plan to end the conflict between Marley and Eldia once and for all." },
  { slug: "hunter-x-hunter-2011", title: "Hunter x Hunter (2011)", titleRomaji: "Hunter x Hunter (2011)", titleEnglish: "Hunter x Hunter", titleNative: "HUNTER×HUNTER(2011)", season: "Fall 2011", score: 9.12, cover: gradients[5], dubbed: true, studios: "Madhouse", format: "TV", genres: "Action, Adventure, Fantasy", episodes: 148, status: "Finished Airing", premiered: "Fall 2011", duration: "23 min per ep", favorites: 7600, synopsis: "Gon Freecss discovers his father is a legendary Hunter. He decides to become a Hunter himself to find his father." },
];
