      ...
      {searchOpen ? (
        <div className="flex-1 flex items-center gap-2 md:hidden">
          <div className="flex-1 flex items-center bg-secondary rounded-md px-3 py-1.5 gap-2">
            ...
            <input ref={inputRef} placeholder="Search" className="bg-transparent text-sm text-foreground placeholder:text-muted-foreground outline-none w-full" />
          </div>
        ...
        <>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <button className="text-muted-foreground hover:text-foreground transition-colors"><MessageCircle size={18} /></button>
