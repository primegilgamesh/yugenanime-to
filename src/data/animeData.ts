...
export const editorsPick: AnimeEntry[] = [
  { slug: "angel-beats", title: "Angel Beats!", titleRomaji: "Angel Beats!", titleEnglish: "Angel Beats!", titleNative: "Angel Beats!", season: "Spring 2010", score: 8.09, cover: gradients[6], studios: "P.A.Works", format: "TV", genres: "Action, Comedy, Drama", episodes: 13, status: "Finished Airing", premiered: "Spring 2010", duration: "24 min per ep", favorites: 3100, trailerUrl: "https://www.youtube.com/embed/fIvC7pxPtKk", synopsis: "Otonashi awakens in the afterlife with no memories. He meets Yuri who leads a rebel group fighting against God." },
